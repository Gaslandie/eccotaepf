...
function pageHeader(eyebrow, title, lead, media = null) {
  const mediaBlock = media
    ? `\n      <div class="page-header-media">${picture(media.base, media.alt, "100vw", Boolean(media.eager))}</div>`
    : "";
...
const indexMain = `<main id="contenu">
    ...
    <section class="section" id="domaines">
      <div class="container">
        ...
        <div class="row g-3 g-lg-4">${services.map((service, index) => `<div class="col-md-6 col-xl-3"><article class="service-tile"><div class="service-tile-media">${picture(service[2], service[3], "(min-width: 1200px) 25vw, (min-width: 768px) 50vw, 100vw")}</div><div class="service-tile-body"><span class="service-icon" aria-hidden="true">${domainIcons[index]}</span><h3 class="h5">${service[1]}</h3><p class="mb-0">${service[4]}</p><a class="card-link" href="services.html#${service[0]}">Voir le domaine</a></div></article></div>`).join("")}</div>
      </div>
    </section>
...
const aboutMain = `<main id="contenu">
    ${pageHeader("L'entreprise", "Entreprise de Commerce, Construction, Transport, Agriculture, Élevage, Pêche & Fournitures.", "Créée le 03 novembre 2015, ECCOTA-EPF est une entreprise individuelle dirigée par Youssouf Fila SIDIBE.", { base: "assets/img/theme/equipe-chantier", alt: "Équipe technique réunie sur un chantier", eager: true })}
    <section class="section"><div class="container content-narrow"><p class="eyebrow">Identité et direction</p><h2>Une entreprise guinéenne créée le 03 novembre 2015.</h2><p>ECCOTA-EPF signifie Entreprise de Commerce, Construction, Transport, Agriculture, Élevage, Pêche & Fournitures.</p><p>Sa forme juridique est l'entreprise individuelle. La direction est assurée par <strong>Youssouf Fila SIDIBE</strong>, Directeur Général / Gérant.</p><p class="mb-0"><strong>Vision :</strong> « Investir pour le développement durable en Guinée et en Afrique de l'Ouest ».</p></div></section>
